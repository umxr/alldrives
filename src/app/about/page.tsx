      ...
      <div className="px-6 lg:px-8 pt-20">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-6 text-lg leading-8 text-gray-300">
            Passion for driving, love for breathtaking routes. All Drives -
            where enthusiasts unite, seek, and savor journeys together.
          </p>
        </div>
      </div>
      <div className="mx-auto mt-20 max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-none">
          <div className="grid max-w-xl grid-cols-1 gap-8 text-base leading-7 text-gray-300 lg:max-w-none lg:grid-cols-2">
            ...
            <div>
              <p>
                Our passion for exploration drives us to curate the most
                awe-inspiring driving routes imaginable. From winding coastal
                drives that hug the ocean to challenging mountain passes with
                breathtaking vistas, each route is selected to awaken the
                thrill-seeker within you. Every drive is an opportunity to
                experience the wonders of our world.
              </p>
              <p className="mt-8">
